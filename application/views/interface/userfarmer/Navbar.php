        ...
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
            ...
            <li class="nav-item border-dashed">
                <a href="<?= $farms; ?>" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
                    <span><i class="fa fa-tractor"></i> Farm & <i class="fa fa-carrot"></i> Produce</span>
                </a>
            </li>
            <li class="nav-item border-dashed">
                <a href="<?= $farms; ?>" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
            ...
            <li class="nav-item border-dashed">
                <a href="<?= $produce; ?>" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
